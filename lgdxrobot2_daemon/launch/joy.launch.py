...
. install/setup.bash
ros2 launch lgdxrobot2_daemon joy.launch.py
ros2 launch lgdxrobot2_daemon joy.launch.py rviz:=false # Without Rviz
"""
...
def launch_setup(context):
    ...
    lgdxrobot2_mcu_node = Node(
        ...
        parameters=[{
            ...
            'serial_port_control_mode': 'joy',
            'serial_port_publish_odom': True,
            'serial_port_publish_tf': True,
            'serial_port_reset_transform': True
        }]
    )
    joy_node = Node(
        package='joy',
    ...
    return [robot_state_publisher_node, joint_state_publisher_node, rviz_node, lgdxrobot2_mcu_node, joy_node]
