...
. install/setup.bash
ros2 launch lgdxrobot2_bringup simulation_nav.launch.py slam:=True
ros2 launch lgdxrobot2_bringup simulation_nav.launch.py slam:=True use_explore_lite:=True
